...
export function renderPaymentSummary() {
  ...
  cart.forEach((cartItem) => {
    ...
    shippingPricaeCents += matchingDeliveryOption.priceCents;
  });

  const totalBeforeTaxCents = productPriceCents + shippingPricaeCents;
  ...
  const paymentSummaryHtml = `
    ...
    <div class="payment-summary-money">
    $${formatCurrency(shippingPricaeCents)}</div>
    </div>
